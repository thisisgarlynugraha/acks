...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('images/logo/acks.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('images/logo/acks.png') }}">
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="{{ asset('images/logo/acks.png') }}" alt="logo" width="150">
                        </div>
